...
async def file_view(
    ...
    try:
        ...
        await query.answer(
            ...
            "❌ Could not verify file ownership.",
    ...
    for file in files:
        ...
        current_filename = get_file_value(
        ...
        keyboard = [
            ...
            [
                ...
                InlineKeyboardButton(
                    ...
                    callback_data=f"input_file|{filename}"
            ...
            [
                ...
                InlineKeyboardButton(
                    ...
                    callback_data=f"modules_panel|{filename}"
...
async def delete_user_file(
    ...
    await safe_edit(
        ...
        "This will remove the file from your account.",
